...
### Fixed
- **Content List Status**: Fixed translation status showing "Not translated" for pages even when translated (list query was using hardcoded 'post' instead of actual post types)
...
### Fixed
- **Translate Page**: Fixed translations not loading for pages (was using hardcoded 'post' instead of actual post type)
- **Translate Button**: Fixed "Auto-translate all fields" button not showing for proxy mode users (credits-based)
- **Variable Error**: Fixed undefined variable error on translate page
...
### Fixed
- **Meta Fields Filtering**: Aligned filtering patterns between admin display and API translation.
